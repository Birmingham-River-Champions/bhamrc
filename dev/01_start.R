...
golem::fill_desc(
  ...
  authors = c(
    person(
      ...
      family = "White", # Your Last Name
      email = "AUTHOR@MAIL.COM", # Your email
      role = c("aut", "cre") # Your role (here author/creator)
    ),
    person(
      given = "Christine", # Your First Name
      family = "Stawitz", # Your Last Name
      email = "c.c.stawitz@bham.ac.uk", # Your email
      role = "aut" # Your role (here author/creator)
    )
  ),
...
usethis::use_code_of_conduct(contact = "James White")
